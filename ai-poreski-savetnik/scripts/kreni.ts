...
if (!imaKljuc) {
  console.log(
    [
      ...
      "  \x1b[33m│\x1b[0m    1. uzmite ga na console.anthropic.com                  \x1b[33m│\x1b[0m",
      "  \x1b[33m│\x1b[0m    2. otvorite .env i upišite ANTHROPIC_API_KEY=sk-ant-…  \x1b[33m│\x1b[0m",
      "  \x1b[33m│\x1b[0m    3. Ctrl+C pa opet: npm run kreni                       \x1b[33m│\x1b[0m",
      "  \x1b[33m└──────────────────────────────────────────────────────────┘\x1b[0m",
      "",
    ].join("\n"),
  );
