...
export const PROPISI: SeedPropis[] = [
  ...
  {
    skracenica: "ZFLS",
    naziv: "Zakon o finansiranju lokalne samouprave",
    tip: "ZAKON",
    kategorija: "IMOVINA",
    donosilac: "Narodna skupština Republike Srbije",
    izvorInstitucija: "Paragraf Lex",
    izvorUrl: `${PARAGRAF}/zakon_o_finansiranju_lokalne_samouprave.html`,
    prioritetIzvora: 6,
    verifikacija: "DELIMICNO",
    napomena:
      "Osnov za lokalne komunalne takse, pre svega firmarinu. Visinu utvrđuje odluka jedinice lokalne samouprave, pa konačan iznos uvek treba proveriti kod nadležne lokalne poreske administracije.",
  },
  {
    skracenica: "ZASP",
    naziv: "Zakon o autorskom i srodnim pravima",
    tip: "ZAKON",
    kategorija: "OSTALO",
    donosilac: "Narodna skupština Republike Srbije",
    sluzbeniGlasnik: [
      ...
      "99/2011",
      "119/2012",
      "29/2016 (odluka Ustavnog suda)",
      "66/2019",
    ],
    izvorInstitucija: "Paragraf Lex",
    izvorUrl: `${PARAGRAF}/zakon_o_autorskom_i_srodnim_pravima.html`,
    prioritetIzvora: 6,
    verifikacija: "DELIMICNO",
    napomena:
      "Osnov za naknade SOKOJ-u i OFPS-u za javno saopštavanje muzike — obaveza koju ugostitelji redovno previde.",
  },
  {
    skracenica: "ZUG",
